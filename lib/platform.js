...
MiAqaraPlatform.prototype.parseConfig = function (config) {
...
MiAqaraPlatform.prototype.scheduleDeviceAutoRemoval = function () {
  var platform = this;
...
MiAqaraPlatform.prototype.queryGateway = function (command, parameters, port, ip) {
...
MiAqaraPlatform.prototype.processGatewayEvent = function (event, gatewayIp) {
 ...
 * @param token
 */
MiAqaraPlatform.prototype.rememberGatewayToken = function (gatewayId, token) {
...
MiAqaraPlatform.prototype.findGatewayByDevice = function (deviceId) {
  return this.devices[deviceId].underGateway;
};

MiAqaraPlatform.prototype.getAccessoryCommonName = function (accessoryType) {
...
MiAqaraPlatform.prototype.registerHomeKitAccessory = function (accessoryIdAsSerialNumber,
